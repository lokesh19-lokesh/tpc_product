    ...
    <div className="solution-page">
      ...
      <section className="solution-hero">
        <div className="container relative z-10">
          ...
          <h1 className="text-white drop-shadow-lg">Data and AI</h1>
          <p className="subtitle text-primary drop-shadow-md">Turn raw data into actionable intelligence</p>
          ...
          <div className="challenge-grid">
            <div className="challenge-box">
              ...
              <p className="text-secondary leading-relaxed text-lg">
                Enterprises are drowning in data but starving for insights. Data is scattered across multiple databases, inconsistent, and ultimately useless for driving strategic business decisions.
              </p>
            </div>
            <div className="solution-box">
              ...
              <p className="text-secondary leading-relaxed text-lg">
                We build robust data pipelines that clean, transform, and centralize your data. We then apply advanced machine learning models and AI to extract predictive insights that give you a competitive edge.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="container">
          ...
          <div className="rich-features-grid">
            ...
            <div className="rich-feature-card">
              ...
              <p className="text-secondary leading-relaxed">Centralizing structured and unstructured data using Snowflake, BigQuery, or Databricks.</p>
            </div>
            ...
            <div className="rich-feature-card">
              ...
              <p className="text-secondary leading-relaxed">Automated data extraction, transformation, and loading for real-time analytics.</p>
            </div>
            ...
            <div className="rich-feature-card">
              ...
              <p className="text-secondary leading-relaxed">Statistical models that forecast market trends, inventory needs, and customer behavior.</p>
            </div>
            ...
            <div className="rich-feature-card">
              ...
              <p className="text-secondary leading-relaxed">Implementing LLMs to automate customer support, content generation, and code writing.</p>
            </div>
            ...
            <div className="rich-feature-card">
              ...
              <p className="text-secondary leading-relaxed">Image and video analysis for manufacturing defect detection and security monitoring.</p>
            </div>
            ...
            <div className="rich-feature-card">
              ...
              <p className="text-secondary leading-relaxed">Interactive visualizations via Tableau and PowerBI for executive decision making.</p>
            </div>
      ...
      <section className="solution-tech-stack">
        <div className="container text-center">
          ...
          <div className="tech-grid">
            <div className="tech-badge">Python</div><div className="tech-badge">Snowflake</div><div className="tech-badge">TensorFlow</div><div className="tech-badge">PyTorch</div><div className="tech-badge">OpenAI</div><div className="tech-badge">PowerBI</div>
          </div>
        </div>
      </section>
      ...
      <section className="solution-faq">
        <div className="container">
          <div className="text-center">
            ...
            <p className="text-secondary">Common questions about our Data and AI engagements.</p>
          </div>
          <div className="faq-container">
            
            <div className="faq-item">
              <h4>How do we prepare our messy data for AI?</h4>
              <p>Our data engineers first build automated ETL pipelines to clean, normalize, and centralize your data into a modern data warehouse before any AI models are applied.</p>
            </div>
            
            <div className="faq-item">
              <h4>Can Generative AI actually improve our operations?</h4>
              <p>Yes. We are currently implementing custom-trained LLMs to automate level-1 customer support, draft technical reports, and summarize legal documents, saving thousands of hours.</p>
            </div>
            
            <div className="faq-item">
              <h4>Is our data secure when using AI models?</h4>
              <p>We only use enterprise-grade AI instances (like Azure OpenAI) where your data is ring-fenced and never used to train public models.</p>
            </div>
      ...
      <section className="bg-gray-50 py-24 text-center border-t border-gray-200">
        <div className="container">
          <h2 className="text-4xl font-bold mb-6">Ready to Transform with Data and AI?</h2>
