    ...
    <div className="solution-page">
      ...
      <section className="solution-hero">
        <div className="container">
          ...
          <h1>UI/UX Design</h1>
          <p>Crafting digital experiences that captivate</p>
      ...
      <section className="solution-overview">
        <div className="container">
          ...
          <p>Modern enterprises require robust, scalable, and secure technological foundations. Our UI/UX Design offering is designed to meet these exact needs.</p>
      ...
      <section className="solution-cta">
        <div className="container">
          <h2>Ready to Transform with UI/UX Design?</h2>
