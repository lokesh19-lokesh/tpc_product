  ...
  return (
    <div className="solution-page">
      <SEO 
        ...
        description="Explore our Cyber Security solutions to accelerate digital transformation, ensure compliance, and build robust enterprise architectures." 
        keywords="Cyber Security solutions, digital transformation, AI for Cyber Security, enterprise architecture"
      ...
      <section className="solution-hero">
        <div className="container relative z-10">
          ...
          <h1 className="text-white drop-shadow-lg">Cyber Security</h1>
          <p className="subtitle text-primary drop-shadow-md">Protect your enterprise from evolving digital threats</p>
          <p className="text-gray-200 text-xl leading-relaxed mt-4 drop-shadow-sm" style={{ maxWidth: '750px', margin: '0 auto 2.5rem' }}>
            Safeguard your most critical data and infrastructure with proactive threat hunting, compliance frameworks, and zero-trust security architectures.
          </p>
          ...
          <div className="challenge-grid">
            <div className="challenge-box">
              ...
              <p className="text-secondary leading-relaxed text-lg">
                Cyber threats are becoming increasingly sophisticated. A single breach can result in millions of dollars in damages, intellectual property theft, and irreversible brand destruction.
              </p>
            </div>
            <div className="solution-box">
              ...
              <p className="text-secondary leading-relaxed text-lg">
                We implement multi-layered defense mechanisms ranging from endpoint protection to advanced threat intelligence. We assume breach and design zero-trust environments that limit blast radiuses and stop lateral movement.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="container">
          ...
          <div className="rich-features-grid">
            ...
            <div className="rich-feature-card">
              ...
              <p className="text-secondary leading-relaxed">Ethical hacking to identify and patch vulnerabilities before malicious actors exploit them.</p>
            </div>
            ...
            <div className="rich-feature-card">
              ...
              <p className="text-secondary leading-relaxed">Centralized logging and real-time analysis of security alerts.</p>
            </div>
            ...
            <div className="rich-feature-card">
              ...
              <p className="text-secondary leading-relaxed">Advanced monitoring to detect ransomware and malware at the device level.</p>
            </div>
            ...
            <div className="rich-feature-card">
              ...
              <p className="text-secondary leading-relaxed">Policies and tools to prevent sensitive data from leaving your corporate network.</p>
            </div>
            ...
            <div className="rich-feature-card">
              ...
              <p className="text-secondary leading-relaxed">On-call forensic experts ready to contain and eradicate active security breaches.</p>
            </div>
            ...
            <div className="rich-feature-card">
              ...
              <p className="text-secondary leading-relaxed">Educating your workforce to recognize and report phishing and social engineering attacks.</p>
            </div>
      ...
      <section className="solution-tech-stack">
        <div className="container text-center">
          ...
          <div className="tech-grid">
            <div className="tech-badge">CrowdStrike</div><div className="tech-badge">Splunk</div><div className="tech-badge">Tenable</div><div className="tech-badge">Okta</div><div className="tech-badge">Kali Linux</div><div className="tech-badge">Burp Suite</div>
          </div>
        </div>
      </section>
      ...
      <section className="solution-faq">
        <div className="container">
          <div className="text-center">
            ...
            <p className="text-secondary">Common questions about our Cyber Security engagements.</p>
          </div>
          <div className="faq-container">
            
            <div className="faq-item">
              <h4>Do you offer 24/7 monitoring?</h4>
              <p>Yes. Our Security Operations Center (SOC) provides continuous, round-the-clock threat hunting and alert triage.</p>
            </div>
            
            <div className="faq-item">
              <h4>What happens if we get breached?</h4>
              <p>Our incident response team immediately steps in to contain the threat, eradicate the malware, and recover data, minimizing operational downtime.</p>
            </div>
            
            <div className="faq-item">
              <h4>How often should we perform penetration tests?</h4>
              <p>We recommend comprehensive manual penetration testing annually, combined with automated vulnerability scanning on a weekly or daily basis.</p>
            </div>
      ...
      <section className="bg-gray-50 py-24 text-center border-t border-gray-200">
        <div className="container">
          <h2 className="text-4xl font-bold mb-6">Ready to Transform with Cyber Security?</h2>
