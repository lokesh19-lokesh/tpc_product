  ...
  return (
    <div className="solution-page">
      <SEO 
        ...
        description="Explore our Digital Strategy solutions to accelerate digital transformation, ensure compliance, and build robust enterprise architectures." 
        keywords="Digital Strategy solutions, digital transformation, AI for Digital Strategy, enterprise architecture"
      ...
      <section className="solution-hero">
        <div className="container relative z-10">
          ...
          <h1 className="text-white drop-shadow-lg">Digital Strategy</h1>
          <p className="subtitle text-primary drop-shadow-md">Blueprint your digital transformation journey</p>
          <p className="text-gray-200 text-xl leading-relaxed mt-4 drop-shadow-sm" style={{ maxWidth: '750px', margin: '0 auto 2.5rem' }}>
            Navigate the complexities of the digital age with expert consulting. We help you align your technology investments with your long-term business goals.
          </p>
          ...
          <div className="challenge-grid">
            <div className="challenge-box">
              ...
              <p className="text-secondary leading-relaxed text-lg">
                Many companies invest heavily in new technologies without a cohesive plan, resulting in "digital islands" that fail to integrate or deliver measurable return on investment.
              </p>
            </div>
            <div className="solution-box">
              ...
              <p className="text-secondary leading-relaxed text-lg">
                We act as your strategic partner. We analyze your current market position, identify digital gaps, and build a comprehensive roadmap that ensures technology drives real business value rather than just overhead.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="container">
          ...
          <div className="rich-features-grid">
            ...
            <div className="rich-feature-card">
              ...
              <p className="text-secondary leading-relaxed">Multi-year strategic plans prioritizing technology investments based on ROI.</p>
            </div>
            ...
            <div className="rich-feature-card">
              ...
              <p className="text-secondary leading-relaxed">Benchmarking your current capabilities against industry leaders and competitors.</p>
            </div>
            ...
            <div className="rich-feature-card">
              ...
              <p className="text-secondary leading-relaxed">Strategies to ensure high employee adoption rates for new digital tools and processes.</p>
            </div>
            ...
            <div className="rich-feature-card">
              ...
              <p className="text-secondary leading-relaxed">Restructuring teams and governance models to support agile, digital-first operations.</p>
            </div>
            ...
            <div className="rich-feature-card">
              ...
              <p className="text-secondary leading-relaxed">Unbiased analysis and procurement strategy for enterprise software and hardware.</p>
            </div>
            ...
            <div className="rich-feature-card">
              ...
              <p className="text-secondary leading-relaxed">Facilitated design thinking sessions to uncover new digital business models.</p>
            </div>
      ...
      <section className="solution-tech-stack">
        <div className="container text-center">
          ...
          <div className="tech-grid">
            <div className="tech-badge">Miro</div><div className="tech-badge">Notion</div><div className="tech-badge">Lucidchart</div><div className="tech-badge">Gartner Magic Quadrants</div><div className="tech-badge">SWOT Analysis</div><div className="tech-badge">Agile Frameworks</div>
          </div>
        </div>
      </section>
      ...
      <section className="solution-faq">
        <div className="container">
          <div className="text-center">
            ...
            <p className="text-secondary">Common questions about our Digital Strategy engagements.</p>
          </div>
          <div className="faq-container">
            
            <div className="faq-item">
              <h4>How long does a strategy engagement take?</h4>
              <p>A typical initial digital maturity assessment and roadmapping engagement takes 4 to 8 weeks, delivering a clear 3-year execution plan.</p>
            </div>
            
            <div className="faq-item">
              <h4>Do you implement the strategy as well?</h4>
              <p>Yes. We are an end-to-end consultancy. The same team that designs the blueprint can bring in our engineering pods to build the actual software.</p>
            </div>
            
            <div className="faq-item">
              <h4>How do you measure the success of digital transformation?</h4>
              <p>We establish clear KPIs upfront—ranging from customer acquisition cost and employee retention to raw infrastructure cost savings.</p>
            </div>
      ...
      <section className="bg-gray-50 py-24 text-center border-t border-gray-200">
        <div className="container">
          <h2 className="text-4xl font-bold mb-6">Ready to Transform with Digital Strategy?</h2>
