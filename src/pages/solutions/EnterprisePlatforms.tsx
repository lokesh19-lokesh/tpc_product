  ...
  return (
    <div className="solution-page">
      <SEO 
        ...
        description="Explore our Enterprise Platforms solutions to accelerate digital transformation, ensure compliance, and build robust enterprise architectures." 
        keywords="Enterprise Platforms solutions, digital transformation, AI for Enterprise Platforms, enterprise architecture"
        path="/solutions/enterprise-platforms" 
      />
      {/* 1. HERO SECTION */}
      <section className="solution-hero">
        <div className="container relative z-10">
          ...
          <h1 className="text-white drop-shadow-lg">Enterprise Platforms</h1>
          <p className="subtitle text-primary drop-shadow-md">Foundation for enterprise-wide scalability</p>
          <p className="text-gray-200 text-xl leading-relaxed mt-4 drop-shadow-sm" style={{ maxWidth: '750px', margin: '0 auto 2.5rem' }}>
            Build and deploy comprehensive enterprise platforms that centralize your operations, enhance collaboration, and provide a single source of truth.
          </p>
          ...
          <div className="challenge-grid">
            <div className="challenge-box">
              ...
              <p className="text-secondary leading-relaxed text-lg">
                Fragmented departmental systems create conflicting data, duplicate work, and severe communication breakdowns between business units.
              </p>
            </div>
            <div className="solution-box">
              ...
              <p className="text-secondary leading-relaxed text-lg">
                We design unified enterprise platforms that connect all business functions. By standardizing APIs and data structures, we create a highly collaborative environment where information flows seamlessly.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="container">
          ...
          <div className="rich-features-grid">
            ...
            <div className="rich-feature-card">
              ...
              <p className="text-secondary leading-relaxed">Designing modular, multi-tenant architectures capable of supporting global operations.</p>
            </div>
            ...
            <div className="rich-feature-card">
              ...
              <p className="text-secondary leading-relaxed">Creating centralized API gateways to standardize how internal systems communicate.</p>
            </div>
            ...
            <div className="rich-feature-card">
              ...
              <p className="text-secondary leading-relaxed">Single Sign-On (SSO) and role-based access control across the entire platform.</p>
            </div>
            ...
            <div className="rich-feature-card">
              ...
              <p className="text-secondary leading-relaxed">Ensuring absolute consistency of critical data entities across all business units.</p>
            </div>
            ...
            <div className="rich-feature-card">
              ...
              <p className="text-secondary leading-relaxed">B2B and B2C scalable commerce engines capable of handling massive transaction volumes.</p>
            </div>
            ...
            <div className="rich-feature-card">
              ...
              <p className="text-secondary leading-relaxed">Transitioning your on-premise software into highly scalable Software-as-a-Service platforms.</p>
            </div>
      ...
      <section className="solution-tech-stack">
        <div className="container text-center">
          ...
          <div className="tech-grid">
            <div className="tech-badge">Spring Boot</div><div className="tech-badge">GraphQL</div><div className="tech-badge">Apigee</div><div className="tech-badge">Keycloak</div><div className="tech-badge">PostgreSQL</div><div className="tech-badge">Redis</div>
          </div>
        </div>
      </section>
      ...
      <section className="solution-faq">
        <div className="container">
          <div className="text-center">
            ...
            <p className="text-secondary">Common questions about our Enterprise Platforms engagements.</p>
          </div>
          <div className="faq-container">
            
            <div className="faq-item">
              <h4>What is a multi-tenant architecture?</h4>
              <p>It allows a single instance of software to serve multiple distinct customer groups (tenants) securely. This is the foundational architecture of modern SaaS applications.</p>
            </div>
            
            <div className="faq-item">
              <h4>How do you handle authorization across a massive platform?</h4>
              <p>We implement centralized Identity Providers (IdP) like Keycloak or Auth0, utilizing OIDC and OAuth2 for secure, token-based Single Sign-On.</p>
            </div>
            
            <div className="faq-item">
              <h4>Can this replace our existing software?</h4>
              <p>Eventually. We use an API-first design. We build the platform and slowly route traffic away from your old systems, seamlessly decommissioning them over time.</p>
            </div>
      ...
      <section className="bg-gray-50 py-24 text-center border-t border-gray-200">
        <div className="container">
          <h2 className="text-4xl font-bold mb-6">Ready to Transform with Enterprise Platforms?</h2>
