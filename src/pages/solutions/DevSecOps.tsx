    ...
    <div className="solution-page">
      ...
      <section className="solution-hero">
        <div className="container">
          ...
          <h1>DevSecOps</h1>
          <p>Security integrated at the speed of DevOps</p>
      ...
      <section className="solution-overview">
        <div className="container">
          ...
          <p>Modern enterprises require robust, scalable, and secure technological foundations. Our DevSecOps offering is designed to meet these exact needs.</p>
      ...
      <section className="solution-cta">
        <div className="container">
          <h2>Ready to Transform with DevSecOps?</h2>
