    ...
    <div className="solution-page">
      ...
      <section className="solution-hero">
        <div className="container relative z-10">
          ...
          <h1 className="text-white drop-shadow-lg">Mobile App Development</h1>
          <p className="subtitle text-primary drop-shadow-md">Native and cross-platform mobile experiences</p>
          <p className="text-gray-200 text-xl leading-relaxed mt-4 drop-shadow-sm" style={{ maxWidth: '750px', margin: '0 auto 2.5rem' }}>
            Build high-performance, engaging mobile applications for iOS and Android. From consumer apps to enterprise mobility solutions, we deliver excellence in your pocket.
          </p>
          ...
          <div className="challenge-grid">
            <div className="challenge-box">
              ...
              <p className="text-secondary leading-relaxed text-lg">
                Building separate codebases for iOS and Android doubles development costs and complicates feature parity. Meanwhile, poorly optimized apps drain battery and suffer from lag.
              </p>
            </div>
            <div className="solution-box">
              ...
              <p className="text-secondary leading-relaxed text-lg">
                We build high-performance mobile solutions using the right technology for your needs—whether that is pure Native for maximum performance or frameworks like React Native for unified codebases.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="container">
          ...
          <div className="rich-features-grid">
            ...
            <div className="rich-feature-card">
              ...
              <p className="text-secondary leading-relaxed">High-performance Swift applications deeply integrated with the Apple ecosystem.</p>
            </div>
            ...
            <div className="rich-feature-card">
              ...
              <p className="text-secondary leading-relaxed">Robust Kotlin applications optimized across thousands of Android devices.</p>
            </div>
            ...
            <div className="rich-feature-card">
              ...
              <p className="text-secondary leading-relaxed">React Native and Flutter solutions to cut development time in half.</p>
            </div>
            ...
            <div className="rich-feature-card">
              ...
              <h3>Mobile UI/UX</h3>
              <p className="text-secondary leading-relaxed">Touch-optimized interfaces designed specifically for mobile ergonomics.</p>
            </div>
            ...
            <div className="rich-feature-card">
              ...
              <p className="text-secondary leading-relaxed">Robust local databases allowing the app to function without internet connectivity.</p>
            </div>
            ...
            <div className="rich-feature-card">
              ...
              <p className="text-secondary leading-relaxed">Guidance through the rigorous Apple and Google review and release processes.</p>
            </div>
      ...
      <section className="solution-tech-stack">
        <div className="container text-center">
          ...
          <div className="tech-grid">
            <div className="tech-badge">Swift</div><div className="tech-badge">Kotlin</div><div className="tech-badge">React Native</div><div className="tech-badge">Flutter</div><div className="tech-badge">Firebase</div><div className="tech-badge">SQLite</div>
          </div>
        </div>
      </section>
      ...
      <section className="solution-faq">
        <div className="container">
          <div className="text-center">
            ...
            <p className="text-secondary">Common questions about our Mobile App Development engagements.</p>
          </div>
          <div className="faq-container">
            
            <div className="faq-item">
              <h4>Should we build Native or Cross-platform?</h4>
              <p>If you need intense hardware integrations or high-end graphics (like gaming), go Native. For 90% of business apps, React Native or Flutter provides identical performance for half the cost.</p>
            </div>
            
            <div className="faq-item">
              <h4>Can you rescue a failing mobile app project?</h4>
              <p>Yes. We frequently conduct code audits to identify memory leaks, architecture flaws, and performance bottlenecks to bring failing apps back to life.</p>
            </div>
            
            <div className="faq-item">
              <h4>Do you handle the App Store submissions?</h4>
              <p>Absolutely. We handle all certificates, provisioning profiles, and App Store review communications for you.</p>
            </div>
      ...
      <section className="bg-gray-50 py-24 text-center border-t border-gray-200">
        <div className="container">
          <h2 className="text-4xl font-bold mb-6">Ready to Transform with Mobile App Development?</h2>
