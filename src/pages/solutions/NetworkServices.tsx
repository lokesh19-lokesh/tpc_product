    ...
    <div className="solution-page">
      ...
      <section className="solution-hero">
        <div className="container relative z-10">
          ...
          <h1 className="text-white drop-shadow-lg">Network Services</h1>
          <p className="subtitle text-primary drop-shadow-md">Robust and scalable connectivity for the modern enterprise</p>
          <p className="text-gray-200 text-xl leading-relaxed mt-4 drop-shadow-sm" style={{ maxWidth: '750px', margin: '0 auto 2.5rem' }}>
            Ensure seamless communication and high-speed data transfer across your organization with our comprehensive network architecture and management services.
          </p>
          ...
          <div className="challenge-grid">
            <div className="challenge-box">
              ...
              <p className="text-secondary leading-relaxed text-lg">
                Traditional networks struggle to support the bandwidth and security demands of a modern, distributed workforce. Frequent bottlenecks and blind spots compromise productivity and expose the enterprise to threats.
              </p>
            </div>
            <div className="solution-box">
              ...
              <p className="text-secondary leading-relaxed text-lg">
                We design and deploy intelligent, software-defined networks that dynamically route traffic for optimal performance. Our solutions guarantee high availability, secure remote access, and absolute visibility.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="container">
          ...
          <div className="rich-features-grid">
            ...
            <div className="rich-feature-card">
              ...
              <h3>SD-WAN Implementation</h3>
              <p className="text-secondary leading-relaxed">Software-defined routing for secure, cost-effective, and high-performance branch connectivity.</p>
            </div>
            ...
            <div className="rich-feature-card">
              ...
              <p className="text-secondary leading-relaxed">Decouple network resources from hardware to improve flexibility and scalability.</p>
            </div>
            ...
            <div className="rich-feature-card">
              ...
              <p className="text-secondary leading-relaxed">Strict identity verification for every user and device attempting to connect.</p>
            </div>
            ...
            <div className="rich-feature-card">
              ...
              <p className="text-secondary leading-relaxed">Proactive NOC services to detect anomalies and resolve issues before they impact users.</p>
            </div>
            ...
            <div className="rich-feature-card">
              ...
              <p className="text-secondary leading-relaxed">Securely connect on-premise infrastructure to AWS, Azure, and Google Cloud environments.</p>
            </div>
            ...
            <div className="rich-feature-card">
              ...
              <h3>Disaster Recovery Routing</h3>
              <p className="text-secondary leading-relaxed">Automated failover mechanisms ensuring network availability during critical outages.</p>
            </div>
      ...
      <section className="solution-tech-stack">
        <div className="container text-center">
          ...
          <div className="tech-grid">
            <div className="tech-badge">Cisco</div><div className="tech-badge">Juniper</div><div className="tech-badge">Palo Alto</div><div className="tech-badge">Fortinet</div><div className="tech-badge">VMware NSX</div><div className="tech-badge">SolarWinds</div>
          </div>
        </div>
      </section>
      ...
      <section className="solution-faq">
        <div className="container">
          <div className="text-center">
            ...
            <p className="text-secondary">Common questions about our Network Services engagements.</p>
          </div>
          <div className="faq-container">
            
            <div className="faq-item">
              <h4>What is SD-WAN and why do we need it?</h4>
              <p>SD-WAN replaces expensive MPLS lines with software-defined routing over standard internet connections. It lowers costs while drastically improving speed and security.</p>
            </div>
            
            <div className="faq-item">
              <h4>How do you handle remote workers?</h4>
              <p>We implement Zero-Trust Network Access (ZTNA) solutions, which are far more secure and faster than traditional enterprise VPNs.</p>
            </div>
            
            <div className="faq-item">
              <h4>Can you integrate our on-premise servers with the cloud?</h4>
              <p>Yes. We design high-speed, encrypted IPsec tunnels and direct connections (like AWS Direct Connect) to bridge your physical and cloud networks.</p>
            </div>
      ...
      <section className="bg-gray-50 py-24 text-center border-t border-gray-200">
        <div className="container">
          <h2 className="text-4xl font-bold mb-6">Ready to Transform with Network Services?</h2>
