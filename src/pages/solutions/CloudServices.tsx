    ...
    <div className="solution-page">
      ...
      <section className="solution-hero">
        <div className="container">
          ...
          <p>Scalable, secure, and resilient cloud infrastructure</p>
      ...
      <section className="solution-overview">
        <div className="container">
          ...
          <p>Modern enterprises require robust, scalable, and secure technological foundations. Our Cloud Services offering is designed to meet these exact needs.</p>
      ...
      <section className="solution-cta">
        <div className="container">
          <h2>Ready to Transform with Cloud Services?</h2>
