...
export function Terms() {
  return (
    <LegalLayout title="Terms of Service" lastUpdated="July 1, 2026">
      ...
      <p>
        By accessing the services, you agree that you have read, understood, and agree to be bound by all of these Terms of Service. If you do not agree, you are expressly prohibited from using the services.
      </p>
      ...
      <ul>
        ...
        <li>You will not access the Services through automated or non-human means without our authorization (e.g., scraping, unauthorized API access).</li>
      ...
      <ul>
        ...
        <li>Use the AI outputs to generate harmful, illegal, or malicious content.</li>
      </ul>

      <h2>5. Subscription and Payment</h2>
      <p>
        Certain enterprise features of our AI platform require a paid subscription. By selecting a subscription plan, you agree to pay The Patterns Company the subscription fees indicated for that service. Payments will be charged on a pre-pay basis on the day you sign up for an upgrade and will cover the use of that service for a monthly or annual subscription period as indicated.
      </p>
      ...
      <p>
        These Terms shall be governed by and defined following the laws of the State of Delaware, United States. The Patterns Company and yourself irrevocably consent that the courts of Delaware shall have exclusive jurisdiction to resolve any dispute which may arise in connection with these terms.
      </p>
    </LegalLayout>
  );
}
